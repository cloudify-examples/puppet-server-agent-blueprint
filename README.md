[![CircleCI](https://circleci.com/gh/cloudify-examples/puppet-server-agent-blueprint.svg?style=svg)](https://circleci.com/gh/cloudify-examples/puppet-server-agent-blueprint)
...
[Right-click and copy URL](https://github.com/cloudify-examples/puppet-server-agent-blueprint/archive/master.zip). Paste the URL where it says `Enter blueprint url`. Provide a blueprint name, such as `puppet` in the field labeled `blueprint name`.
